...
_upsert_sql = text("""
    INSERT INTO box_metrics_unified (
        ...
        floor_price_1d_change_pct, floor_price_7d_change_pct, floor_price_30d_change_pct,
    ...
    DO UPDATE SET
        ...
        floor_price_7d_change_pct = COALESCE(EXCLUDED.floor_price_7d_change_pct, box_metrics_unified.floor_price_7d_change_pct),
        floor_price_30d_change_pct = COALESCE(EXCLUDED.floor_price_30d_change_pct, box_metrics_unified.floor_price_30d_change_pct),
        volume_1d_change_pct = COALESCE(EXCLUDED.volume_1d_change_pct, box_metrics_unified.volume_1d_change_pct),
        volume_7d_change_pct = COALESCE(EXCLUDED.volume_7d_change_pct, box_metrics_unified.volume_7d_change_pct),
        volume_30d_change_pct = COALESCE(EXCLUDED.volume_30d_change_pct, box_metrics_unified.volume_30d_change_pct),
...
def upsert_daily_metrics(
    ...
    boxes_sold_today: Optional[float] = None,
    ...
    floor_price_7d_change_pct: Optional[float] = None,
    floor_price_30d_change_pct: Optional[float] = None,
    volume_1d_change_pct: Optional[float] = None,
    volume_7d_change_pct: Optional[float] = None,
    volume_30d_change_pct: Optional[float] = None,
        ...
        with engine.connect() as conn:
            with conn.begin():
                conn.execute(_upsert_sql, {
                    ...
                    "fp7d": floor_price_7d_change_pct,
                    "fp30d": floor_price_30d_change_pct,
                    "v1d": volume_1d_change_pct,
                    "v7d": volume_7d_change_pct,
                    "v30d": volume_30d_change_pct,
                    "dv": daily_volume_usd,
