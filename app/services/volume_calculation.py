...
def calculate_volume_from_sparse_data(
    ...
    Args:
        ...
        boxes_sold_today: Average boxes sold per day
    ...
    """
    if not floor_price or not boxes_sold_today or boxes_sold_today <= 0:
        return 0.0
    ...
    daily_volume = average_sale_price * boxes_sold_today
...
def calculate_volume_from_daily_snapshots(
    ...
    Args:
        daily_snapshots: List of daily snapshot data with:
            ...
            - boxes_sold_today: Boxes sold on that day
    ...
    for snapshot in recent_snapshots:
        ...
        boxes_sold = snapshot.get('boxes_sold_today', 0) or 0
