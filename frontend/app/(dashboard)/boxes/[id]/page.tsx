    ...
    <ProtectedRoute>
      <div className="min-h-screen" style={{ background: 'linear-gradient(180deg, #396EF0 0%, #2d5fe8 30%, #2563eb 60%, #1b5fd8 100%)' }}>
        ...
        <div className="container mx-auto px-6 py-8" style={{ maxWidth: '1400px' }}>
          ...
          {/* Main Product Information Section - Desktop Layout */}
          <div 
          ...
          >
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="grid grid-cols-2 lg:grid-cols-3 gap-3 mb-4">
                  ...
                  {box.metrics.boxes_added_today !== null && box.metrics.boxes_added_today !== undefined && (
                    <div>
                      <div className="text-white/70 text-sm mb-1">Added Today</div>
                      <div className="text-lg font-semibold text-white">
            ...
            {/* Price Chart - Full Width Below Content */}
            <div className="mt-6 pt-6 border-t border-white/10">
              ...
              {/* Price Chart */}
              {isLoadingTimeSeries ? (
                <div className="h-80 flex items-center justify-center border border-white/10 rounded-lg bg-white/5 w-full">
                  <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-white/30"></div>
                </div>
              ) : timeSeriesData && timeSeriesData.length > 0 ? (
                <div className="border border-white/10 rounded-lg bg-white/5 p-6 h-80 w-full overflow-hidden">
          ...
          >
            <h2 className="text-xl font-bold text-white mb-4">Market Notes & Signals</h2>
          ...
          >
            <h2 className="text-xl font-bold text-white mb-6">Complete Metrics Overview</h2>
          ...
          >
            <h2 className="text-xl font-bold text-white mb-4">Data Sources & Context</h2>
