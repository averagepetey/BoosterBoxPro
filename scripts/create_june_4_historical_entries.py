"""
Create historical entries for June 4, 2025 data
"""
...
def create_historical_entries():
    ...
    for box in leaderboard.get("data", []):
        ...
        if key not in june_4_data:
            continue
        
        box_data = june_4_data[key]
