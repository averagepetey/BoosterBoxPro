"""
Create historical entries for December 25, 2025 data
"""
...
december_25_data = {
    "OP-01 (Blue)": {
        "floor_price_usd": 3998.49,
        "active_listings_count": 0,
        "boxes_sold_per_day": 1.38,
    },
    "OP-01 (White)": {
        "floor_price_usd": 1431.94,
        "active_listings_count": 3,
        "boxes_sold_per_day": 1.86,
    },
    "OP-02": {
        "floor_price_usd": 378.17,
        "active_listings_count": 27,
        "boxes_sold_per_day": 2.43,
    },
    "OP-03": {
        "floor_price_usd": 392.02,
        "active_listings_count": 4,
        "boxes_sold_per_day": 0.93,
    },
    "OP-04": {
        "floor_price_usd": 365.23,
        "active_listings_count": 13,
        "boxes_sold_per_day": 0.96,
    },
    "OP-05": {
        "floor_price_usd": 776.05,
        "active_listings_count": 28,
        "boxes_sold_per_day": 4.64,
    },
    "OP-06": {
        "floor_price_usd": 256.90,
        "active_listings_count": 134,
        "boxes_sold_per_day": 3.14,
    },
    "EB-01": {
        "floor_price_usd": 765.78,
        "active_listings_count": 2,
        "boxes_sold_per_day": 1.18,
    },
    "OP-07": {
        "floor_price_usd": 192.50,
        "active_listings_count": 38,
        "boxes_sold_per_day": 3.25,
    },
    "OP-08": {
        "floor_price_usd": 153.22,
        "active_listings_count": 72,
        "boxes_sold_per_day": 1.96,
    },
    "PRB-01": {
        "floor_price_usd": 738.72,
        "active_listings_count": 8,
        "boxes_sold_per_day": 1.11,
    },
    "OP-09": {
        "floor_price_usd": 421.27,
        "active_listings_count": 58,
        "boxes_sold_per_day": 3.93,
    },
    "OP-10": {
        "floor_price_usd": 154.65,
        "active_listings_count": 43,
        "boxes_sold_per_day": 3.25,
    },
    "EB-02": {
        "floor_price_usd": 445.00,
        "active_listings_count": 6,
        "boxes_sold_per_day": 1.46,
    },
    "OP-11": {
        "floor_price_usd": 244.32,
        "active_listings_count": 16,
        "boxes_sold_per_day": 4.54,
    },
    "OP-12": {
        "floor_price_usd": 145.27,
        "active_listings_count": 46,
        "boxes_sold_per_day": 4.57,
    },
    "PRB-02": {
        "floor_price_usd": 245.80,
...
def create_historical_entries():
    """Create historical entries for December 25, 2025"""
    ...
    for box in leaderboard.get("data", []):
        ...
        if key not in december_25_data:
            continue
        
        box_data = december_25_data[key]
