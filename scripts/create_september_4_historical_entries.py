"""
Create historical entries for September 4, 2025 data
"""
...
september_4_data = {
    "OP-01 (Blue)": {
        "floor_price_usd": 1920.31,
        "active_listings_count": 0,
        "boxes_sold_per_day": 0.79,
    },
    "OP-01 (White)": {
        "floor_price_usd": 465.29,
        "active_listings_count": 2,
        "boxes_sold_per_day": 0.57,
    },
    "OP-02": {
        "floor_price_usd": 210.88,
        "active_listings_count": 25,
        "boxes_sold_per_day": 0.32,
    },
    "OP-03": {
        "floor_price_usd": 230.87,
        "active_listings_count": 4,
        "boxes_sold_per_day": 0.32,
    },
    "OP-04": {
        "floor_price_usd": 196.93,
        "active_listings_count": 14,
        "boxes_sold_per_day": 0.50,
    },
    "OP-05": {
        "floor_price_usd": 263.67,
        "active_listings_count": 96,
        "boxes_sold_per_day": 2.50,
    },
    "OP-06": {
        "floor_price_usd": 156.79,
        "active_listings_count": 69,
        "boxes_sold_per_day": 1.54,
    },
    "EB-01": {
        "floor_price_usd": 323.37,
        "active_listings_count": 1,
        "boxes_sold_per_day": 0.50,
    },
    "OP-07": {
        "floor_price_usd": 123.87,
        "active_listings_count": 60,
        "boxes_sold_per_day": 1.18,
    },
    "OP-08": {
        "floor_price_usd": 110.66,
        "active_listings_count": 232,
        "boxes_sold_per_day": 0.82,
    },
    "PRB-01": {
        "floor_price_usd": 402.16,
        "active_listings_count": 15,
        "boxes_sold_per_day": 0.68,
    },
    "OP-09": {
        "floor_price_usd": 199.30,
        "active_listings_count": 48,
        "boxes_sold_per_day": 1.68,
    },
    "OP-10": {
        "floor_price_usd": 99.64,
        "active_listings_count": 109,
        "boxes_sold_per_day": 0.71,
    },
    "EB-02": {
        "floor_price_usd": 192.58,
        "active_listings_count": 75,
        "boxes_sold_per_day": 0.93,
    },
    "OP-11": {
        "floor_price_usd": 134.83,
        "active_listings_count": 92,
        "boxes_sold_per_day": 1.18,
    },
}

def create_historical_entries():
    """Create historical entries for September 4, 2025"""
    ...
    for box in leaderboard.get("data", []):
        ...
        if key not in september_4_data:
            continue
        
        box_data = september_4_data[key]
